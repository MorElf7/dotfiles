...
if [ -z "$TMUX_POWERLINE_LEFT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_LEFT_STATUS_SEGMENTS=(
		"mode_indicator #766b90 #dcd7ba ${TMUX_POWERLINE_SEPARATOR_RIGHT_THIN}"
		"tmux_session_info #766b90 #dcd7ba "
		# "hostname 33 0"
		# "ifstat 30 255"
		# "ifstat_sys 30 255"
		# "lan_ip #766b90 #dcd7ba"
...
if [ -z "$TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
		...
		# "now_playing 234 37"
		# "cpu #766b90 #dcd7ba"
		# "load #766b90 #dcd7ba ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
		"tmux_mem_cpu_load #766b90 #dcd7ba ${TMUX_POWERLINE_DEFAULT_RIGHTSIDE_SEPARATOR} no_sep_bg_color no_sep_fg_color no_spacing_disable no_separator_disable"
